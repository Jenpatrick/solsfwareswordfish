...
byte MotorSpeedFull = 80; // For full-pull
byte MotorSpeedHalf = 50; // For half-pull
...
// Motor Controls
#define MOTOR_SPINUP_LAG 250 // How long we give the motors before we know that have spun up.
